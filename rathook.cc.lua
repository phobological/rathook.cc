...
local gui = library:New("Rathook.cc / DEV BUILD 0.0.1")      
...
chat:Element("Toggle", "chat spam", nil, function(tbl)      
	if tbl.Toggle then      
		while values.misc.chat["chat spam"].Toggle do      
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "standard" and "hi" or "RATWARE.CC HITTING P", false, "Innocent", false, true)      
...
CreateHitElement("Initating Ratware.cc...",Color3.new(1,1,0))
...
LocalPlayer.Status.Kills:GetPropertyChangedSignal("Value"):Connect(function(current)      
	...
	if values.misc.chat["kill say"].Toggle then      
		game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat["message"].Text ~= "" and values.misc.chat["message"].Text or "nn's love gettin tapped by ratware.cc!1!1!", false, "Innocent", false, true)      
	end      
end)      
...
ChatScript.createNewMessage("Ratware.cc","Ratware.cc has successfully loaded.",MainUIColor,Color3.new(1,1,1),0.01,nil)
ChatScript.moveOldMessages()
ChatScript.createNewMessage("Ratware.cc","DEV BUILD / 0.0.1",MainUIColor,Color3.new(1,1,1),0.01,nil)
